...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'card[name]='.$first.'&card[number]='.$cc.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&card[address_line1]=Street '.rand(111, 999).'&card[address_line2]=Apartment&card[address_city]=Highlands&card[address_state]=Texas&card[address_zip]=77562&card[address_country]=us');
...
if(strpos($r2, '"seller_message": "Payment complete."' )) {
    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $'.$amt.' CCN CHARGE+REFUND ✅ <br> ➤<br>➤ Receipt : <a href='.$receipturl.'>Here</a><br>';
}
