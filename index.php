		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					...
					<textarea rows="1" class="form-control text-center" style="width:100%; float: left ;"  id="sec" placeholder="sk_live_xxxxxhhh"></textarea></br>
								
					
					          <select name="gate" id="gate" class="form-control" style="margin-top: 0px;">
					<option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd1.php">CVV CHARGE+REFUND </option>
						<option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd2.php">CCN CHARGE+REFUND</option>
							
					
                </select>    
<b class="card-body p-md-0 text-center">  <b class="mt-0 text-=black">l 


           <div class="">
               <br>
		<button class="btn btn-success btn-play text-white" style="width: 40%; float: left;"><i class="fa fa-play"></i> START</button>
					<button class="btn btn-danger btn-stop text-white" style="width: 40%; float: right;" disabled><i class="fa fa-stop"></i> STOP</button>
				</div>
			</div>
		</div>
<div class="col-md-4">
...
<h5>Cvvs:<span class="badge badge-info float-right cvvs">0</span></h5><hr>

<h5>Ccns:<span class="badge badge-primary float-right aprovadas">0</span></h5><hr>

<h5>Deads:<span class="badge badge-danger float-right reprovadas">0</span></h5>
                  </div> 
                </div>
              </div>
